...
about **execution quality**, not new features.
...
| 5 | Manual integration QA (browser-restart catch-up, multi-routine, multi-day boundary) | Requires loading in a real Chrome. |
...
`v1.0.0` — solo project. Auto-close, tab groups, sync, and import/export are
